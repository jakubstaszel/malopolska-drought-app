...
st.write(
    "The amount of cyanobacteria cells is one of the components contributing to the value of chlorophyll a. The values of this parameter are mainly associated with cyanobacterial blooms, which can be hazardous to humans, animals, and plants (Topp et al., 2020). Due to climate change and the influence of anthropogenic factors, these blooms are becoming larger and more frequent."
)
st.subheader("Cyanobacteria Statistics Across Time")
...
st.subheader("Cyanobacteria Spatial Variability")
widget = st.empty()
...
with row1_col2:
    ...
    st.write("Cyanobacteria [1e12 cells/l]")
